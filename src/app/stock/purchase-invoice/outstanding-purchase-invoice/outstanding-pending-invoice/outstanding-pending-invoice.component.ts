...
export class OutstandingPendingInvoiceComponent implements OnInit {
  ...
  checkFormDisability() {
    ...
    console.log('quantity:', this.purchaseInvoiceInformationForm.get('quantity').errors instanceof Object);
    console.log('invoice No:', this.purchaseInvoiceInformationForm.get('invoiceNo').errors instanceof Object);
    console.log('invoiceDt:', this.purchaseInvoiceInformationForm.get('invoiceDt').errors instanceof Object);
    console.log('selectedSupplier:', !(this.selectedSupplier instanceof Object));
    console.log('selectedStatusId:', this.selectedStatusId !== 1); */
  ...
  onRemoveSelected() {
    ...
    console.log(this.purchaseInvoiceGridOptions.api.getSelectedRows());
  }
